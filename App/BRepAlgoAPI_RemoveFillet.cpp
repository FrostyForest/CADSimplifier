#include "BRepAlgoAPI_RemoveFillet.h"
...
//purpose  :
//=======================================================================
void BRepAlgoAPI_RemoveFillet::Build(const Message_ProgressRange& theRange)
{
...
//purpose  :
//=======================================================================
const TopTools_ListOfShape& BRepAlgoAPI_RemoveFillet::Modified(const TopoDS_Shape& theS)
{
...
//purpose  :
//=======================================================================
const TopTools_ListOfShape& BRepAlgoAPI_RemoveFillet::Generated(const TopoDS_Shape& theS)
{
...
//purpose  :
//=======================================================================
Standard_Boolean BRepAlgoAPI_RemoveFillet::IsDeleted(const TopoDS_Shape& theS)
{
...
//purpose  :
//=======================================================================
Standard_Boolean BRepAlgoAPI_RemoveFillet::HasModified() const
{
...
//purpose  :
//=======================================================================
Standard_Boolean BRepAlgoAPI_RemoveFillet::HasGenerated() const
{
...
//purpose  :
//=======================================================================
Standard_Boolean BRepAlgoAPI_RemoveFillet::HasDeleted() const
{
