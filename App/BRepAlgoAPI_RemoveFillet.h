...
//! The BRepAlgoAPI_RemoveFillet algorithm is the API algorithm intended for
...
//! the low-level *BOPAlgo_RemoveFillets* tool. So the defeaturing algorithm
...
//! of *BOPAlgo_RemoveFillets* algorithm.
//!
//! <b>Limitations</b>
//!
//! The defeaturing algorithm has the same limitations as *BOPAlgo_RemoveFillets*
//! algorithm.
//!
//! <b>Example</b>
//!
...
//!
//! BRepAlgoAPI_RemoveFillet aDF;             // De-Featuring algorithm
...
//!
class BRepAlgoAPI_RemoveFillet: public BRepAlgoAPI_Algo
{
public:
...
public://! @name Constructors
    //! Empty constructor
    BRepAlgoAPI_RemoveFillet() : BRepAlgoAPI_Algo(), myFillHistory(Standard_True) {}
...
public://! @name History Methods
    ...
    Modified(const TopoDS_Shape& theS) Standard_OVERRIDE;

    //! Returns the list of shapes generated from the shape <theS> during the operation.
    Standard_EXPORT virtual const TopTools_ListOfShape&
    Generated(const TopoDS_Shape& theS) Standard_OVERRIDE;
